...
export function GiftRegistry() {
  // 1. Estado para controlar cuándo estamos en el cliente
  ...
  // 2. Generamos el array de sobres
  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden" style={{ backgroundColor: '#EDE9DF' }}>
      ...
      {/* --- LLUVIA DE SOBRES DECORATIVA --- */}
      {/* Solo renderizamos esto si isMounted es true */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.15]">
        {isMounted && floatingEnvelopes.map((_, i) => (
          <motion.div
            ...
            initial={{ 
              y: -150, 
              x: `${Math.random() * 100}%`, // Ahora es seguro usarlo aquí
              rotate: 0, 
              opacity: 0 
            }}
            whileInView={{ 
      ...
      <div className="max-w-xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            ...
            la tradición de lluvia de sobres."
          </p>
