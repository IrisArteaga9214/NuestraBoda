...
export function Footer() {
  const whatsappUrl = "https://wa.me/524428200679?text=Hola%20Iris,%20vi%20tu%20trabajo%20en%20la%20invitación%20de%20Daniela%20y%20Roberto%20y%20me%20encantó."
  ...
  return (
    <footer className="py-24 px-6 text-center deckled-top" style={{ backgroundColor: '#EDE9DF' }}>
      ...
      >
        ...
        {/* Sello de Lacre con efecto de "presión" */}
        <motion.div 
        ...
        {/* Separador elegante que se expande */}
