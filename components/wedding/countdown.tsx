  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden" style={{ backgroundColor: '#EDE9DF' }}>
      ...
      <div className="max-w-3xl mx-auto text-center">
        {/* Título: Mantiene el rojo característico */}
        <motion.p
        ...
        {/* Fecha: Gris cálido profundo en lugar de negro */}
        <motion.h2
        ...
        <div className="grid grid-cols-2 gap-y-12 gap-x-6 md:grid-cols-4 md:gap-10">
          {units.map(({ label, value }, index) => (
            ...
            >
              ...
              {/* Etiquetas: Ahora en un tono café suave pero con peso medio para leerse */}
              <span
                className="text-[12px] md:text-xs tracking-[0.3em] uppercase"
                style={{ 
                  color: '#5E544A', // Un tono más café/tierra para armonizar
                  fontFamily: 'var(--font-cormorant)', 
                  fontWeight: 600 
                }}
              >
